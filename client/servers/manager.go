...
const (
	...
	//
	// For example, in a 100K Jobpool cluster with 5x servers, it will
...
type Manager struct {
	// servers is the list of all known Jobpool servers.
	servers Servers

	// rebalanceTimer controls the duration of the rebalance interval
	rebalanceTimer *time.Timer

	// shutdownCh is a copy of the channel in Jobpool.Client
...
// rebalancing the list of Jobpool servers in order to distribute load across
// all known and available Jobpool servers.
